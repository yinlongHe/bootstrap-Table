    ...
    $.fn.extend({  
        colResizable: function(options) {           
            var defaults = {
                ...
                resizeMode: 'overflow',                    //mode can be 'fit', 'flex' or 'overflow' 当前溢出显示滚动条 
                draggingClass: 'JCLRgripDrag',	//css-class used when a grip is being dragged (for visual feedback purposes)
				gripInnerHtml: '<div class="fa fa-caret-down" style="margin-left:1px;color:#ccc"></div>',				//if it is required to use a custom grip it can be done using some custom HTML 表格列之间代码，标识..				
